        ...
        <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-12">
          <div className="grid gap-px bg-bisat-border md:grid-cols-2">
            <div className="bg-white px-6 py-10 sm:px-10">
              ...
              <h2 className="font-serif text-[1.9rem] font-light tracking-[-0.04em] text-bisat-black">1. Share your room</h2>
            ...
            <div className="bg-white px-6 py-10 sm:px-10">
              ...
              <h2 className="font-serif text-[1.9rem] font-light tracking-[-0.04em] text-bisat-black">2. Receive recommendations</h2>
              <p className="mt-4 text-[14px] leading-6 text-bisat-black/56">
