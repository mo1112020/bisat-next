            ...
            >
              ...
              {activeTab === 'Addresses' && (
                <div className="space-y-4">
                  ...
                  <button className="w-full bg-white border border-dashed border-bisat-black/[0.07] p-6 text-bisat-black/30 hover:text-bisat-black hover:border-bisat-black/20 transition-colors text-sm uppercase tracking-widest font-bold">
                    + Add New Address
                  </button>
                </div>
              )}
