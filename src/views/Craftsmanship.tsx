...
export const Craftsmanship = () => {
  return (
    <div className="pb-16 bg-bisat-cream min-h-screen">
      <Meta
        title="Craftsmanship"
        description="Discover the artisanal craft behind every Bisāṭ rug — centuries of tradition, natural materials, and human patience woven into each piece."
      />
      ...
      <section className="max-w-[1320px] mx-auto px-5 sm:px-8 lg:px-12 pt-6">
        <PageHeader
          ...
          description="Every Bisāṭ rug is a product of centuries-old tradition. Skilled artisans across Anatolia and Central Asia hand-knot each piece using time-honoured techniques passed down through generations — no shortcuts, no machines, only patience and craft."
        />
      </section>
      ...
      <section className="max-w-[1320px] mx-auto px-5 sm:px-8 lg:px-12 text-center pb-12">
        ...
        >
          ...
          <span className="text-bisat-gold text-[10px] uppercase tracking-[0.4em] font-bold">Bisāṭ Atelier</span>
        </motion.blockquote>
      </section>
    </div>
  );
